        ...
        <div className='min-h-screen flex items-center justify-center w-full'>
            <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <button className='mt-2 w-full py-2 px-4 rounded-md text-white bg-gray-500 hover:bg-gray-600 transition-all' type='button' onClick={() => setToken('guest')}> Guest Admin Login </button>
                </form>
            </div>
        </div>
    )
